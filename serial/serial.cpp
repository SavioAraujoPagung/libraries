...
static int16_t Serializacao::retornaPosicaoCharString(char* texto, char caractere, uint8_t ocorrencia){
    int16_t posicao=0;
    int16_t temp=0;
...
//posicao começa de 0
static int16_t Serializacao::obtemPosicaoVetorString(char *substring, char* texto, char caractere, uint8_t posicao){
    int16_t inicio, fim;
    int16_t i=0;
    int16_t k=0;
    if(posicao == 0){
...
static int16_t Serializacao::obtemSubstringVetorString(char *substring, char* texto, char caractereInicio, char caractereFim, uint8_t posicao){
    int16_t inicio, fim;
    int16_t i=0;
    int16_t k=0;
    if(posicao == 0){
...
static uint8_t Serializacao::retornaTamanhoVetorString(char* texto, char caractere){
    uint8_t i=0;
    uint8_t tamanho=0;
    while(texto[i]!=0){
...
static void Serializacao::removeCaractere(char * texto, char caractere){
    int i=0;
    int j=0;
